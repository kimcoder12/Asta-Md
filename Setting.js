...
module.exports = {
  sessionName: process.env.SESSION_ID || '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=lAYx0IpC#oSw7qlu8WTqjCqFXbYI_VLt_Pfrk0GF09OuimXaJhsY',
  botname: process.env.BOT_NAME || '&***&',
  ownername:  process.env.OWNER_NAME || `kimcoder`,
  author:  process.env.PACK_AUTHER || 'Astro', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'true',
  packname:  process.env.PACK_NAME || "Asta-Md" , 
  autoreaction: process.env.AUTO_REACTION || 'flase',
  antibadword : process.env.ANTI_BAD_WORD || 'nobadwordokey',
  alwaysonline: process.env.ALWAYS_ONLINE || 'true', 
  antifake :   process.env.FAKE_COUNTRY_CODE ||'254',
  readmessage: process.env.READ_MESSAGE || 'flase',
